...
public class BidsTest {
    ...
    public void setupBid(){
        ...
        sneaker2.add(bid);
        sneaker2.add(new Bid("6", 200));
        sneaker2.add(new Bid("9.5", 479));
        sneaker2.add(new Bid("13", 338));
        sneaker2.add(new Bid("9.5", 480));
    ...
    public void testCheckCriteria() {
        ...
        assertEquals(bids.checkCriteria(sneaker), bids.checkCriteria(sneaker2));
    }
}
/*Un test un poco cutre, pero creo que cumple su proposito, creo unas sneakers que tienen solo Bids
y la comparo con una que tiene Asks y Bids.
 */
